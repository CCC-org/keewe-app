...
export const REACTIONS: Record<string, any>[] = [
  ...
  { xml: HeartRoundOffXml, bezier: [0.5, 1.8, 0.4, 1.15], color: theme.colors.graphic.green },
  { xml: SadRoundOffXml, bezier: [0.5, 1.8, 0.4, 1.3], color: theme.colors.graphic.purple },
  { xml: SurpriseRoundOffXml, bezier: [0.5, 1.8, 0.4, 1.45], color: theme.colors.graphic.coral },
  { xml: EyesRoundOffXml, bezier: [0.5, 1.8, 0.4, 1.6], color: theme.colors.graphic.marine },
  { xml: FireRoundOffXml, bezier: [0.5, 1.8, 0.4, 1.75], color: theme.colors.graphic.orange },
];
